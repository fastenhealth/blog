...
compromise" analysis, set forth in 45 CFR §164.402(2)." By the way, this isn’t a big ask of HHS \- in the original 
HIPAA breach notification rule, OCR already stated in guidance that if information is misdirected to "another entity 
